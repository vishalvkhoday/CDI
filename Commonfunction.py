...
def ChromeDriver():
    try:
        ...
        driver = webdriver.Chrome(executable_path="C:/Users/DELL/eclipse-workspace/CDI/WebDriver/chromedriver", options=WebOptions)
    ...
    while True:
        try:
            if brwObj.is_displayed() or brwObj.is_enabled() == True:
                rptStepDetails("Pass","Object exist hence exiting")
                break
            else:
                sleep(3)
                intcount =intcount+1
                if intcount >= 15:
                    ...
                    rptStepDetails("Pass","Waiting for object to load.....")
        except:
                sleep(3)
                intcount =intcount+1
                if intcount >= 15:
                    break
                rptStepDetails("Fail","object not found..... Still waiting")
...
def fn_ClickOnNewQuote():
    try:
        ...
        print("Known error please try again")
...
def fn_EnterQuoteSummaryInfo():
    ...
    rptStepDetails("Pass", "QuoteName "+strQuoteName)
    ...
    Browser.find_element_by_xpath("//input[@id='id-c7a4eb13-1549-ea11-a812-000d3a5a11b0-9-customerid8-customerid.fieldControl-LookupResultsDropdown_customerid_4_textInputBox_with_filter_new']").send_keys(Keys.ENTER)
#     Browser.find_element_by_xpath("//input[@id='id-c7a4eb13-1549-ea11-a812-000d3a5a11b0-9-customerid8-customerid.fieldControl-LookupResultsDropdown_customerid_4_textInputBox_with_filter_new']").send_keys("TurnTable Testing Company")
    sleep(2)
    Browser.find_element_by_xpath("//*[contains(text(),'Turntable Testing Company')]").click()
    sleep(2)
